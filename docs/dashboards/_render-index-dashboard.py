    ...
    <div class="container">
        ...
        <div class="tab-panel active" id="panel-tests">
            <section>
                ...
                <h3 id="tests-versiondiff" class="tests-subsection-heading" style="margin-top: 8px;">Version-diff comparisons &mdash; how v1.2.0 stacks against earlier releases</h3>
...
{versiondiff_cards_html}
                ...
                <h3 id="tests-baseline" class="tests-subsection-heading" style="margin-top: 48px;">Absolute baselines &mdash; how v1.2.0 stands on its own terms</h3>
...
{pending_card}
        ...
        <div class="tab-panel" id="panel-how">
            <section>
                ...
                <div class="grid cols-2">
                    <a class="card step-card" href="https://codeberg.org/CupertinoHQ/cupertino/src/branch/main/scripts/eval/search-quality-phase1.py#L74-L133">
                    ...
                    <a class="card step-card" href="https://codeberg.org/CupertinoHQ/cupertino/src/branch/main/scripts/eval/search-quality-phase1.py">
                    ...
                    <a class="card step-card" href="https://codeberg.org/CupertinoHQ/cupertino/src/branch/main/docs/audits">
