...
| Property | Value |
|---|---|
| Source id | `apple-archive` |
| URI scheme | `apple-archive://TP40014097/about-views` |
| Approx. documents | ~368 |
| Approx. size | ~25 MB |
| Schema version (`PRAGMA user_version`) | 18 |

Legacy apple programming guides (core animation, quartz 2d, kvo/kvc, etc.).
