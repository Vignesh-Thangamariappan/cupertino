# hig.db - Human Interface Guidelines FTS5 Index

Per-source SQLite FTS5 database for Human Interface Guidelines. One of the eight per-source databases produced by the v1.3.0 split of the former unified `search.db` (#1036).

## Location

**Default**: `~/.cupertino/hig.db`
...
Apple hig pages (foundations / patterns / components / inputs / technologies).
