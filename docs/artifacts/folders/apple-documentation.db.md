...
Per-source SQLite FTS5 database for Apple Developer Documentation. One of the eight per-source databases produced by the v1.3.0 split of the former unified `search.db` (#1036).
