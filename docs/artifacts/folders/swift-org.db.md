# swift-org.db - Swift.org FTS5 Index

Per-source SQLite FTS5 database for Swift.org. One of the eight per-source databases produced by the v1.3.0 split of the former unified `search.db` (#1036).

## Location

**Default**: `~/.cupertino/swift-org.db`
...
|---|---|
| Source id | `swift-org` |
| URI scheme | `swift-org://concurrency` |
| Approx. documents | ~469 |
| Approx. size | ~14 MB |
