# swift-evolution.db - Swift Evolution FTS5 Index

Per-source SQLite FTS5 database for Swift Evolution. One of the eight per-source databases produced by the v1.3.0 split of the former unified `search.db` (#1036).

## Location

**Default**: `~/.cupertino/swift-evolution.db`
...
| Property | Value |
|---|---|
| Source id | `swift-evolution` |
| URI scheme | `swift-evolution://SE-0306` |
| Approx. documents | ~487 |
| Approx. size | ~25 MB |
