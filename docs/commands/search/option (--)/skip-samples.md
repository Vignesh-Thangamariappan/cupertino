...
Excludes the `apple-sample-code.db`-backed source from fan-out search. Useful when apple-sample-code.db is missing/stale or when you only care about docs + packages. (#239)
